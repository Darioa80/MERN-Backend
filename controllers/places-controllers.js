...
const deletePlaceByID = async (req,res,next) => {
    ...
    if(place.creator.id !== req.userData.userId){   //added userID to request in previous middleware, creator is the full user model due to previous populate function
